...
const ViewSubmission = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const submissionRes = await assignmentsAPI.getSubmission(assignmentId, submissionId);
  ...
  const handleGrade = async () => {
    try {
      setGrading(true);
      const res = await assignmentsAPI.gradeSubmission(assignmentId, submissionId);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          {!submission?.grade && (
            ...
            >
              {grading ? 'Grading...' : 'Grade Submission (AI)'}
            </button>
          )}
        </div>
        ...
        {submission?.grade && (
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">AI Grading Results</h2>
